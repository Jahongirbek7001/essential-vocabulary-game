    ...
    return (
        <>
            <div className="wrapper">
                ...
                <div className="letter-button hide">
                    ...
                    <button className="lettersBtn border-2 w-[48px] h-[48px] text-lg font-semibold text-gray-800 bg-white border-gray-200 rounded-lg dark:text-indigo-400  dark:border-indigo-400">P</button><br />
                    ...
                    <button className="lettersBtn border-2 w-[48px] h-[48px] text-lg font-semibold text-gray-800 bg-white border-gray-200 rounded-lg dark:text-indigo-400  dark:border-indigo-400">L</button><br />
